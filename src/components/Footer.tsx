...
//           <span className="text-brand-primary/40">SAZZAD PORTFOLIO</span>
//           <span className="h-3 w-[1px] bg-white/10" />
//           <span className="text-slate-600">PORT 3000 // STATUS: OPTIMAL</span>
//         </div>

//         <div className="text-brand-primary/60 text-center">
//           BUILT WITH INTELLIGENCE & PASSION BY {USER_NAME}
//         </div>
...
//             </a>
//           ))}
//           <span className="text-slate-700">&copy; 2026 ARCHITECTURE</span>
//         </div>
//       </div>
//     </footer>
//   );
